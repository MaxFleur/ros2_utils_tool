...
EditBagThread::run()
{
    ...
    // which generates a decompressed bag file. If we had multiple of these, every reader would regenerate
    // the decompressed file, possibly interrupting the already running writer for this topic.
