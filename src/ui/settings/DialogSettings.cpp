...
DialogSettings::write()
{
    ...
    writeParameter(m_groupName, "low_diskspace_threshold", m_parameters.lowDiskspaceThreshold);
...
DialogSettings::read()
{
    ...
    m_parameters.lowDiskspaceThreshold = readParameter(m_groupName, "low_diskspace_threshold", 10);
